...
describe("Sweep Proof", () => {
  describe("constructSweepProof", () => {
    ...
    context("when the sweep transaction has one input", () => {
      ...
      const expectedTxVersion = "01000000"
      const expectedTxInputVector =
        "01672ae7c34d6a225797f0e005f6ed53ee40252811a37e90f62b68eb5e587be68e" +
        "0000000000ffffffff"
      const expectedTxOutput =
        "01d0200000000000001600148db50eb52063ea9d98b3eac91489a90f738986f6"
      const expectedLocktime = "00000000"
      ...
      const expectedTxIndexInBlock = 11
      const expectedBitcoinHeaders =
      ...
      beforeEach(async () => {
        ...
        const transaction: Transaction = {
          transactionHash:
            "d8ac9c9fe115f02fc52131c69ac6483a65c588fa1a8927a2b5c3fc5766414f9d",
          blockHash:
        ...
        const latestBlockHeight = 2164335
        bitcoinClient.latestHeight = latestBlockHeight
        ...
        bitcoinClient.headersChain = headersChain

        const transactionMerkle = {
          blockHeight: 2164152,
          merkle: [
        ...
        proof = await TBTC.constructSweepProof(
          txHash,
          confirmations,
          bitcoinClient
        )
    ...
    context("when the sweep transaction has multiple inputs", () => {
      ...
      const expectedTxIndexInBlock = 6
      const expectedBitcoinHeaders =
      ...
      beforeEach(async () => {
        ...
        const transaction: Transaction = {
          transactionHash:
            "c59a8f7daf075f92b742eae9541068792ef22a83df58d26b06b31f9ad0d84833",
          blockHash:

...
sidechain implementations. The code specific to individual chains should be
placed in a chain-specific directory, in a separate NPM project:
...
Each `cross-chain` component for Ethereum subchain should contain L1 and L2

...
To make sure that these transactions get posted, we need an eth pool that
provides gas refunds for anyone submitting these transactions. We know the
amount of gas spent, and we know the gas price used, and so can reimburse the
operator.

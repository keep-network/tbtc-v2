...
waiting. We can accommodate them with the following flow:
...
depositor's eth address. Once the depositor has paid the contract, the account
...
`skip_sweep_timeout`, then the system seizes the balance, mints TBTC, uses it
